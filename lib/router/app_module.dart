...
import 'package:mubrm_tag/pages/active_page.dart';
import 'package:mubrm_tag/pages/active_page_phone.dart';
...
import 'package:mubrm_tag/pages/search_page.dart';
...
class AppModule extends MainModule {
  ...
  List<ModularRouter> get routers => [
    ...
    ModularRouter("/search_page",
            child: (_, args) => SearchPage(), transition: TransitionType.fadeIn),
