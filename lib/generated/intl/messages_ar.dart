...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "deviceNotSupportApp" : MessageLookupByLibrary.simpleMessage("يرجى فتح خاصية NFC أولا حتى يتمكن التطبيق من القراءة والكتابة على الشريحة"),
    "deviceNotSupportAppIos" : MessageLookupByLibrary.simpleMessage("يرجى فتح خاصية AirPod أولا حتى يتمكن التطبيق من القراءة والكتابة على الشريحة"),
    ...
    "phoneNumberIs" : m1,
    "phoneNumberSuccess" : MessageLookupByLibrary.simpleMessage("تغعيل الرقم"),
